- dashboard: daily_pulse_imported
  title: Daily Pulse (imported)
  layout: newspaper
  description: ''
  preferred_slug: ceXDeyCCwBXpwTaoMa80Ph
  embed_style:
    background_color: ''
    show_title: true
    title_color: "#5c4ac3"
  ...
  - name: "<span class='fa fa-usd'> Monetization </span>"
    ...
    subtitle_text: <p> Are we building a sustainable business? Go to <a href="/dashboards/1838"
  ...
  - title: D7 Retention
    ...
    filters:
      events.user_first_seen_date: '2023'
    limit: 500
    column_limit: 50
  ...
  - title: D1 Retention
    ...
    filters:
      events.user_first_seen_date: 45 days ago for 45 days
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - name: Date Range
    title: Date Range
    type: field_filter
    default_value: 2023/02/15 to 2023/03/02
